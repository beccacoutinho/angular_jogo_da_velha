...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializaro jogo. Define a exibição da tela inicial
   * 
   * @return void
   */
  ...
  /**
   * Inicializar o tabuleiro do jogo com vaxio para todas
   * as posições
   * 
   * @return void
   */
  ...
  /**
   * Retorna se a tela do início deve ser exibida
   * 
   * @return boolean
   */
  ...
  get showTabuleiro(): boolean{
   ...
   /**
   * Retorna se a tela de fim de jogo deve ser ser exibida
   * 
   * @return boolean
   */
   ...
   */
    ...
    fimJogo(linha: number, coluna: number, tabuleiro: any, jogador: number){
      ...
      if(tabuleiro[linha][0] === jogador && 
        tabuleiro[linha][1] === jogador && tabuleiro[linha][2] === jogador){
        fim = [[linha,0],[linha,1],[linha,2]];
      }

      //valida a coluna
      if(tabuleiro[0][coluna] === jogador && 
        tabuleiro[1][coluna] === jogador && tabuleiro[2][coluna] === jogador){
          fim = [[0, coluna],[1, coluna],[2, coluna]];
        }
      // valida as diagonais
      if (tabuleiro[0][0] === jogador &&
        tabuleiro[1][1] === jogador && tabuleiro[2][2] === jogador){
          fim = [[0,0],[1,1],[2,2]];
        }
